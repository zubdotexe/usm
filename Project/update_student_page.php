...
<body>
    ...
    <div class= "headline"><h2>Update Student Information</h2></div>
    <hr>

    <div id= "form">
        <form action= "update_student.php" class= "form_design" method= "post">
            ...
            <input type= "text" name= "phon_no" placeholder= "Phone Number"> <br> <br>
