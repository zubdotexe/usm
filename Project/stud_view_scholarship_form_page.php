...
<head>
    ...
    <title>View Scholarship Request Info</title>
...
<body>
    ...
    <div class="headline"><h2>View Scholarship Request Info</h2></div>
    <hr>
    
    <div id= "form">
        <form action= "stud_view_scholarship_form.php" class= "form_design" method= "post">
