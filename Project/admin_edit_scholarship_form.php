...
<head>
    ...
    <title>Scholarship Form (Pending)</title>
...
<body>
    ...
    <div class= "headline"><h2>Scholarship Form (Pending)</h2></div>
    <hr>
    <br>
...
$sql = "SELECT * FROM scholarship_form where `status`='Pending';";
...
<div class= "button"> 
        <a href= "admin_edit_sc.php">Edit</a>
    </div>
   ...
   <div class= "headline"><h2> No Pending Scholarship ! </h2></div>
   <?php
